package com.aluralatam.ForoAlura.integrations.curso;
...
public class CursoControllerTest{
    ...
    public void itShouldBeAbleToRegisterCursoAndReturnAResponseEntity()throws Exception {
        ...
        List<Object[]> cursoList=cursoRepository.findAllCourses();
        Object[] newCurso={
        ...
        var lastElement=cursoList.get(cursoList.size()-1);
        assertTrue(Arrays.equals(lastElement, newCurso));
    }
    @Test
    @DisplayName("(Delete)Retorna_ResponseEntity_Body:Response_Accepted")
    ...
    @Test
    @DisplayName("(UPDATE)Retorna_ResponseEntity_Body:Response_OK")
    public void itShouldBeAbleToUpdateCursoAndReturnAResponseEntity()throws Exception{
        ...
        //lista para verificar que se haya guardado en la ddbb
        List<Object[]> cursoList=cursoRepository.findAllCourses();
        Object[] newCurso={nuevoCurso.getNombre(),nuevoCurso.getCategoria()};
        //asserts
        assertEquals(HttpStatus.OK, response.getHttpStatus());
        assertEquals(Message.UPDATED, response.getRespuesta());
        assertTrue(Arrays.equals(cursoList.get(cursoList.size()-1), newCurso));
    }
    @Test
    @DisplayName("(Reactiva)Retorna_ResponseEntity_Body:Response_Accepted")
    ...
    @Test
    @DisplayName("(Desactiva)Retorna_ResponseEntity_Body:Response_Accepted")
    ...
    @Test
    @DisplayName("Retorna_ResponseEntity_Body:Curso(ID)")
    ...
    @Test
    @DisplayName("Retorna_ResponseEntity_Body:Curso(NOMBRE-CATEGORIA)")
